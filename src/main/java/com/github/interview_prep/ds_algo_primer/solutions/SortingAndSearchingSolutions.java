...
public class SortingAndSearchingSolutions {
    ...
    private static final Logger LOGGER =
            Logger.getLogger(SortingAndSearchingSolutions.class.getName());
    ...
    public static void main(String[] args) {
        ...
        LOGGER.log(Level.INFO, String.valueOf(binarySearch(new int[] {1, 2, 3, 4, 5, 6}, 5)));

        // System.out.println(closestNumber(new int[] { 1, 2, 3, 4, 5, 6 }, 0));
        LOGGER.log(Level.INFO, String.valueOf(closestNumber(new int[] {1, 2, 3, 4, 5, 6}, 0)));
        // System.out.println(closestNumber(new int[]{1,2,5,6}, 3));
        LOGGER.log(Level.INFO, String.valueOf(closestNumber(new int[] {1, 2, 5, 6}, 3)));
        // System.out.println(closestNumber(new int[] { 1, 6 }, 3));
        LOGGER.log(Level.INFO, String.valueOf(closestNumber(new int[] {1, 6}, 3)));

        // System.out.println(searchRotatedArray(new int[] { 4, 5, 6, 7, 0, 1, 2 }, 0));
        LOGGER.log(
                Level.INFO, String.valueOf(searchRotatedArray(new int[] {4, 5, 6, 7, 0, 1, 2}, 0)));
        // System.out.println(searchRotatedArray(new int[] { 4, 5, 6, 7, 0, 1, 2 }, 3));
        LOGGER.log(
                Level.INFO, String.valueOf(searchRotatedArray(new int[] {4, 5, 6, 7, 0, 1, 2}, 3)));
        ...
        LOGGER.log(Level.INFO, Arrays.toString(arr2));
        ...
        while (l != null) {
            ...
            LOGGER.log(Level.INFO, String.valueOf(l.val));
            l = l.next;
        }

        // System.out.println(largestNumber(new int[] { 3, 30, 34, 5, 9 }));
        LOGGER.log(Level.INFO, String.valueOf(largestNumber(new int[] {3, 30, 34, 5, 9})));

        // System.out.println(squareRoot(4));
        LOGGER.log(Level.INFO, String.valueOf(squareRoot(4)));
        // System.out.println(squareRoot(8));
        LOGGER.log(Level.INFO, String.valueOf(squareRoot(8)));

        // System.out.println(splitLargest(new int[] { 7, 2, 5, 10, 8 }, 2));
        LOGGER.log(Level.INFO, String.valueOf(splitLargest(new int[] {7, 2, 5, 10, 8}, 2)));
    }
}
